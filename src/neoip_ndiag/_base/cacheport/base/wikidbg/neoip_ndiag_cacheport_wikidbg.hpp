...
#ifndef __NEOIP_NDIAG_CACHEPORT_WIKIDBG_HPP__ 
#define __NEOIP_NDIAG_CACHEPORT_WIKIDBG_HPP__ 
/* system include */
/* local include */
...
// declaration of the wikidbg_init_cb_t for ndiag_cacheport_t
void ndiag_cacheport_wikidbg_init(wikidbg_keyword_db_t &keyword_db)	throw();


NEOIP_NAMESPACE_END

#endif	/* __NEOIP_NDIAG_CACHEPORT_WIKIDBG_HPP__  */
