...
#ifndef __NEOIP_TLS_PRIVCTX_WIKIDBG_HPP__ 
#define __NEOIP_TLS_PRIVCTX_WIKIDBG_HPP__ 
/* system include */
/* local include */
...
// declaration of the wikidbg_init_cb_t for tls_privctx_t
void tls_privctx_wikidbg_init(wikidbg_keyword_db_t &keyword_db)	throw();


NEOIP_NAMESPACE_END

#endif	/* __NEOIP_TLS_PRIVCTX_WIKIDBG_HPP__  */
