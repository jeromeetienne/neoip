...
#ifndef __NEOIP_X509_PRIVKEY_NUNIT_HPP__ 
#define __NEOIP_X509_PRIVKEY_NUNIT_HPP__ 
/* system include */
/* local include */
 ...
 */
class x509_privkey_testclass_t : public nunit_testclass_api_t {
private:
public:
	/*************** nunit test function	*******************************/
...
#endif	/* __NEOIP_X509_PRIVKEY_NUNIT_HPP__  */
