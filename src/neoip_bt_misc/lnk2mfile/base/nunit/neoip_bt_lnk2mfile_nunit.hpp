/*! \file
    \brief Header of the test of bt_lnk2mfile_t
*/


#ifndef __NEOIP_BT_LNK2MFILE_NUNIT_HPP__ 
#define __NEOIP_BT_LNK2MFILE_NUNIT_HPP__ 
/* system include */
/* local include */
...
/** \brief Class which implement a nunit for the bt_lnk2mfile_t
 */
class bt_lnk2mfile_testclass_t : public nunit_testclass_api_t, private bt_lnk2mfile_cb_t {
private:
...
public:
	/*************** ctor/dtor	***************************************/
	bt_lnk2mfile_testclass_t()	throw();
	~bt_lnk2mfile_testclass_t()	throw();
...
#endif	/* __NEOIP_BT_LNK2MFILE_NUNIT_HPP__  */
