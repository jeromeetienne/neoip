...
#ifndef __NEOIP_NIPMEM_TRACKER_HTTP_WIKIDBG_HPP__ 
#define __NEOIP_NIPMEM_TRACKER_HTTP_WIKIDBG_HPP__ 
/* system include */
/* local include */
...
// declaration of the wikidbg_init_cb_t for nipmem_tracker_t
void nipmem_tracker_http_wikidbg_init(wikidbg_keyword_db_t &keyword_db)	throw();


NEOIP_NAMESPACE_END

#endif	/* __NEOIP_NIPMEM_TRACKER_HTTP_WIKIDBG_HPP__  */
