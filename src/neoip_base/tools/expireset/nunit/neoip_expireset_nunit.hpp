...
#ifndef __NEOIP_EXPIRESET_NUNIT_HPP__ 
#define __NEOIP_EXPIRESET_NUNIT_HPP__ 
/* system include */
/* local include */
...
/** \brief Class which implement a nunit for the expireset_t
 */
class expireset_testclass_t : public nunit_testclass_api_t, private timeout_cb_t {
private:
	nunit_testclass_ftor_t		nunit_ftor; //!< the functor to notify nunit_res_t asynchronously 
	expireset_t<std::string> *	expireset;

	timeout_t	timeout;	//!< the timeout to test the async notification of the nunit_res_t
	bool 		neoip_timeout_expire_cb(void *userptr, timeout_t &cb_timeout)	throw();
public:
	/*************** ctor/dtor	***************************************/
	expireset_testclass_t()		throw();
	~expireset_testclass_t()	throw();
...
#endif	/* __NEOIP_EXPIRESET_NUNIT_HPP__  */
