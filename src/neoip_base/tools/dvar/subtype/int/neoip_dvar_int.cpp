 ...
 */
dvar_vapi_t *	dvar_int_t::clone()	const throw()
{
	return nipmem_new dvar_int_t(value);	
}
 ...
 */
int 	dvar_int_t::compare(const dvar_vapi_t &other_vapi)	const throw()
{
	// sanity check - check that other_vapi is of the same dvar_type_t
	DBG_ASSERT( other_vapi.type() == type() );
	// convert the other_vapi
	const dvar_int_t &	other	= dynamic_cast <const dvar_int_t &>(other_vapi);
	// compare the value
 ...
 */
std::string	dvar_int_t::to_string()	const throw()
{
