...
NEOIP_STRTYPE_DECLARATION_ITEM(dvar_type_t	, BOOLEAN)
NEOIP_STRTYPE_DECLARATION_ITEM(dvar_type_t	, NIL)
...
NEOIP_STRTYPE_DECLARATION_ITEM_LAST(dvar_type_t)
	...
	bool is_boolean()	const throw() { return get_value() == BOOLEAN;	}
	bool is_nil()		const throw() { return get_value() == NIL;	}
