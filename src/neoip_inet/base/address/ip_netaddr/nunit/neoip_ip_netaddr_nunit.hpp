...
#ifndef __NEOIP_IP_NETADDR_NUNIT_HPP__ 
#define __NEOIP_IP_NETADDR_NUNIT_HPP__ 
/* system include */
/* local include */
 ...
 */
class ip_netaddr_testclass_t : public nunit_testclass_api_t {
private:
public:
	/*************** nunit test function	*******************************/
...
#endif	/* __NEOIP_IP_NETADDR_NUNIT_HPP__  */
