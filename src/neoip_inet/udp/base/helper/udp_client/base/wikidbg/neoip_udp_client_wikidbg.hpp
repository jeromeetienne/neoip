...
#ifndef __NEOIP_UDP_CLIENT_WIKIDBG_HPP__ 
#define __NEOIP_UDP_CLIENT_WIKIDBG_HPP__ 
/* system include */
/* local include */
...
// declaration of the wikidbg_init_cb_t for udp_client_t
void udp_client_wikidbg_init(wikidbg_keyword_db_t &keyword_db)	throw();


NEOIP_NAMESPACE_END

#endif	/* __NEOIP_UDP_CLIENT_WIKIDBG_HPP__  */
