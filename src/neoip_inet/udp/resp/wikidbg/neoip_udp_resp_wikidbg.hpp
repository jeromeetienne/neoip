...
#ifndef __NEOIP_UDP_RESP_WIKIDBG_HPP__ 
#define __NEOIP_UDP_RESP_WIKIDBG_HPP__ 
/* system include */
/* local include */
...
// declaration of the wikidbg_init_cb_t for udp_resp_t
void udp_resp_wikidbg_init(wikidbg_keyword_db_t &keyword_db)	throw();


NEOIP_NAMESPACE_END

#endif	/* __NEOIP_UDP_RESP_WIKIDBG_HPP__  */
