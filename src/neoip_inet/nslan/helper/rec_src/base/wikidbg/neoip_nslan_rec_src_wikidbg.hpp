...
#ifndef __NEOIP_NSLAN_REC_SRC_WIKIDBG_HPP__ 
#define __NEOIP_NSLAN_REC_SRC_WIKIDBG_HPP__ 
/* system include */
/* local include */
...
// declaration of the wikidbg_init_cb_t for nslan_rec_src_t
void nslan_rec_src_wikidbg_init(wikidbg_keyword_db_t &keyword_db)	throw();


NEOIP_NAMESPACE_END

#endif	/* __NEOIP_NSLAN_REC_SRC_WIKIDBG_HPP__  */
