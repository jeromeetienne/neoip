...
#ifndef __NEOIP_NSLAN_PUBLISH_WIKIDBG_HPP__ 
#define __NEOIP_NSLAN_PUBLISH_WIKIDBG_HPP__ 
/* system include */
/* local include */
...
// declaration of the wikidbg_init_cb_t for nslan_publish_t
void nslan_publish_wikidbg_init(wikidbg_keyword_db_t &keyword_db)	throw();


NEOIP_NAMESPACE_END

#endif	/* __NEOIP_NSLAN_PUBLISH_WIKIDBG_HPP__  */
