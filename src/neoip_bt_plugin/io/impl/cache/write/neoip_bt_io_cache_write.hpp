/*! \file
    \brief Header of the bt_io_cache_write_t
    
*/


#ifndef __NEOIP_BT_IO_CACHE_WRITE_HPP__ 
#define __NEOIP_BT_IO_CACHE_WRITE_HPP__ 
/* system include */
/* local include */
...
/** \brief class definition for bt_io_cache_write
 */
class bt_io_cache_write_t : NEOIP_COPY_CTOR_DENY, public bt_io_write_t, private zerotimer_cb_t
		, private bt_io_cache_blkrd_cb_t
		, private wikidbg_obj_t<bt_io_cache_write_t, bt_io_cache_write_wikidbg_init> {
private:
...
public:
	/*************** ctor/dtor	***************************************/
	bt_io_cache_write_t(bt_io_cache_t *io_cache, const file_range_t &totfile_range
				, const datum_t &data2write
				, bt_io_write_cb_t *callback, void *userptr) 		throw();
	~bt_io_cache_write_t()								throw();
	...
	friend class	bt_io_cache_write_wikidbg_t;
};

NEOIP_NAMESPACE_END

#endif	/* __NEOIP_BT_IO_CACHE_WRITE_HPP__  */
