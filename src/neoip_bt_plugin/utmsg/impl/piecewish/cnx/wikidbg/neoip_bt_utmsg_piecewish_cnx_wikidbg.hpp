...
#ifndef __NEOIP_BT_UTMSG_PIECEWISH_CNX_WIKIDBG_HPP__ 
#define __NEOIP_BT_UTMSG_PIECEWISH_CNX_WIKIDBG_HPP__ 
/* system include */
/* local include */
...
#endif	/* __NEOIP_BT_UTMSG_PIECEWISH_CNX_WIKIDBG_HPP__  */
