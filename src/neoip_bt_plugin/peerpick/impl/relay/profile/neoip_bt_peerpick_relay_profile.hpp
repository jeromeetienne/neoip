/*! \file
    \brief Header of the \ref bt_peerpick_relay_profile_t

*/


#ifndef __NEOIP_BT_PEERPICK_RELAY_PROFILE_HPP__ 
#define __NEOIP_BT_PEERPICK_RELAY_PROFILE_HPP__ 
/* system include */
/* local include */
...
/** \brief to handle the profile for the bt_peerpick_relay_t
 */
class bt_peerpick_relay_profile_t : NEOIP_COPY_CTOR_ALLOW {
public:	/////////////////////// constant declaration ///////////////////////////
	//! the default delay for bt_reqauth_type_t::GIVE
...
public:
	/*************** ctor/dtor	***************************************/
	bt_peerpick_relay_profile_t()	throw();
	~bt_peerpick_relay_profile_t()	throw();
...
#	define PROFILE_VAR_PLAIN(var_type, var_name)									\
	...
	public:	const var_type &	var_name()	const throw()	{ return var_name ## _val; }	\
		bt_peerpick_relay_profile_t &	var_name(const var_type &value)	throw()			\
...
#endif	/* __NEOIP_BT_PEERPICK_RELAY_PROFILE_HPP__  */
