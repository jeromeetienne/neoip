...
#ifndef __NEOIP_DNSGRAB_CNX_WIKIDBG_HPP__ 
#define __NEOIP_DNSGRAB_CNX_WIKIDBG_HPP__ 
/* system include */
/* local include */
...
// declaration of the wikidbg_init_cb_t for dnsgrab_cnx_t
void dnsgrab_cnx_wikidbg_init(wikidbg_keyword_db_t &keyword_db)	throw();


NEOIP_NAMESPACE_END

#endif	/* __NEOIP_DNSGRAB_CNX_WIKIDBG_HPP__  */
