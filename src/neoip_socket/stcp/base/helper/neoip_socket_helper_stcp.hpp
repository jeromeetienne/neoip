...
#ifndef __NEOIP_SOCKET_HELPER_STCP_HPP__ 
#define __NEOIP_SOCKET_HELPER_STCP_HPP__ 
/* system include */
/* local include */
...
/** \brief static helpers for the socket stuff with socket_domain_t::STCP
 */
class socket_helper_stcp_t {
...
#endif	/* __NEOIP_SOCKET_HELPER_STCP_HPP__  */
