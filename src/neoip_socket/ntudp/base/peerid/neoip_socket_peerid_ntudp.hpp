...
#ifndef __NEOIP_SOCKET_PEERID_NTUDP_HPP__
#define __NEOIP_SOCKET_PEERID_NTUDP_HPP__
/* system include */
/* local include */
 ...
 */
class socket_peerid_ntudp_t : public socket_peerid_vapi_t {
private:
...
public:
	...
	FACTORY_PRODUCT_DECLARATION(socket_peerid_vapi_t, socket_peerid_ntudp_t);
...
#endif	/* __NEOIP_SOCKET_PEERID_NTUDP_HPP__ */
