/*! \file
    \brief definition of the \ref socket_portid_ntudp_t
*/
...
FACTORY_PRODUCT_DEFINITION(socket_portid_vapi_t, socket_portid_ntudp_t);
 ...
 */
socket_err_t	socket_portid_ntudp_t::ctor_from_str(const std::string &str)	throw()
{
	// parse the input
	ntudp_portid	= str;
 ...
 */
socket_domain_t socket_portid_ntudp_t::get_domain()	const throw()
{
...
/** \brief compare 2 \ref socket_portid_ntudp_t
 */
int	socket_portid_ntudp_t::compare(const socket_portid_vapi_t &other_api)	const throw()
{
	// sanity check - both MUST have the same type
	DBG_ASSERT( typeid(*this) == typeid(other_api) );
	// cast the base class into the derived one
	const socket_portid_ntudp_t &other = dynamic_cast <const socket_portid_ntudp_t&>(other_api);
 ...
 */
std::string	socket_portid_ntudp_t::to_string()				const throw()
{
 ...
 */
void	socket_portid_ntudp_t::serialize(serial_t &serial)			const throw()
{
	serial << ntudp_portid;
}
 ...
 */
void	socket_portid_ntudp_t::unserialize(serial_t &serial)			throw(serial_except_t)
{
	serial >> ntudp_portid;
}
