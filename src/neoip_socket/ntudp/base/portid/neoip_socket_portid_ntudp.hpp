...
#ifndef __NEOIP_SOCKET_PORTID_NTUDP_HPP__
#define __NEOIP_SOCKET_PORTID_NTUDP_HPP__
/* system include */
/* local include */
...
/** \brief socket_domain_t::UDP implementation of the socket_portid_vapi_t
 */
class socket_portid_ntudp_t : public socket_portid_vapi_t {
private:
...
public:
	...
	FACTORY_PRODUCT_DECLARATION(socket_portid_vapi_t, socket_portid_ntudp_t);
...
#endif	/* __NEOIP_SOCKET_PORTID_NTUDP_HPP__ */
