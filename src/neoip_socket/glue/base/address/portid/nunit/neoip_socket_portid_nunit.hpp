/*! \file
    \brief Header of the test of socket_portid_t
*/


#ifndef __NEOIP_SOCKET_PORTID_NUNIT_HPP__ 
#define __NEOIP_SOCKET_PORTID_NUNIT_HPP__ 
/* system include */
/* local include */
...
/** \brief Class which implement a nunit for the socket_portid_t
 */
class socket_portid_testclass_t : public nunit_testclass_api_t {
private:
public:
	/*************** nunit test function	*******************************/
...
#endif	/* __NEOIP_SOCKET_PORTID_NUNIT_HPP__  */
