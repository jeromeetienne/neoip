/*! \file
    \brief Definition of the socket_chargen_server_t class
...
/** \brief Constructor
 */
socket_chargen_server_t::socket_chargen_server_t()	throw()
{
	// zero some field
	socket_resp	= NULL;
}
 ...
 */
socket_err_t	socket_chargen_server_t::start(const socket_resp_arg_t &resp_arg)	throw()
{
 ...
 */
bool	socket_chargen_server_t::neoip_socket_resp_event_cb(void *userptr, socket_resp_t &cb_socket_resp
							, const socket_event_t &socket_event)	throw()
{
	...
	case socket_event_t::CNX_ESTABLISHED:{
			// spawn a socket_chargen_server_cnx_t with the notified socket_full_t
			socket_full_t *	socket_full 	= socket_event.get_cnx_established();
			socket_chargen_server_cnx_t *cnx	= nipmem_new socket_chargen_server_cnx_t(this);
