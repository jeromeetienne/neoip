...
#ifndef __NEOIP_SOCKET_NUNIT_UDP_HPP__
#define __NEOIP_SOCKET_NUNIT_UDP_HPP__
/* system include */
/* local include */
...
/** \brief helper specific to socket_domain_t::UDP for the socket unit
 */
class socket_nunit_udp_t :  private scnx_auth_ftor_cb_t, public socket_nunit_domain_vapi_t {
private:
...
#endif	/* __NEOIP_SOCKET_NUNIT_UDP_HPP__ */
