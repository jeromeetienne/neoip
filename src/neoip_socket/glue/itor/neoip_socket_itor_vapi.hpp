/*! \file
    \brief Header of the \ref socket_itor_vapi_t
*/


#ifndef __NEOIP_SOCKET_ITOR_VAPI_HPP__ 
#define __NEOIP_SOCKET_ITOR_VAPI_HPP__ 

/* system include */
#include <string>
/* local include */
#include "neoip_socket_itor_vapi_cb.hpp"
...
/** \brief Definition of the virtual API for the socket itoronder
 */
class socket_itor_vapi_t {
public:
	/*************** setup function	***************************************/
	virtual void		set_profile(const socket_profile_t &socket_profile)	throw() = 0;
	virtual socket_err_t	setup(const socket_type_t &socket_type, const socket_addr_t &local_addr
					, const socket_addr_t &remote_addr
					,socket_itor_vapi_cb_t *callback, void* userptr)throw() = 0;
	...
	FACTORY_BASE_CLASS_DECLARATION(socket_itor_vapi_t);
	//! virtual destructor
	virtual ~socket_itor_vapi_t() {};
};

// declaration of the factory type
FACTORY_PLANT_DECLARATION(socket_itor_factory, socket_domain_t, socket_itor_vapi_t);

NEOIP_NAMESPACE_END

#endif	/* __NEOIP_SOCKET_ITOR_VAPI_HPP__  */
