...
#ifndef __NEOIP_SOCKET_PORTID_UDP_HPP__
#define __NEOIP_SOCKET_PORTID_UDP_HPP__
/* system include */
/* local include */
 ...
 */
class socket_portid_udp_t : public socket_portid_vapi_t {
private:
...
public:
	...
	FACTORY_PRODUCT_DECLARATION(socket_portid_vapi_t, socket_portid_udp_t);
...
#endif	/* __NEOIP_SOCKET_PORTID_UDP_HPP__ */
