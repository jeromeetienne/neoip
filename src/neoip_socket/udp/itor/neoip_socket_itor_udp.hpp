/*! \file
    \brief Declaration of the \ref socket_itor_udp_t
*/


#ifndef __NEOIP_SOCKET_ITOR_UDP_HPP__
#define __NEOIP_SOCKET_ITOR_UDP_HPP__
/* system include */
#include <iostream>
/* local include */
...
/** \brief class for the \ref socket_itor_t of the UDP domain
 */
class socket_itor_udp_t : public socket_itor_vapi_t, public udp_client_cb_t, public nlay_itor_cb_t
									, public timeout_cb_t {
private:
	...
	/*************** udp_client_t stuff	*******************************/	
	udp_client_t *		udp_client;	//!< to initiate the udp connection
	bool			neoip_udp_client_event_cb(void *userptr, udp_client_t &cb_udp_client
							, const udp_event_t &udp_event)	throw();
	bool			recv_udp_cnx_established()				throw();
	bool			recv_udp_data(pkt_t &pkt)				throw();
...
public:
	...
	FACTORY_PRODUCT_DECLARATION_NOCLONE(socket_itor_vapi_t, socket_itor_udp_t);
};

NEOIP_NAMESPACE_END

#endif	/* __NEOIP_SOCKET_ITOR_UDP_HPP__ */
