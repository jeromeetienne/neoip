...
#ifndef __NEOIP_SOCKET_FULL_UDP_HPP__
#define __NEOIP_SOCKET_FULL_UDP_HPP__
/* system include */
#include <iostream>
/* local include */
 ...
 */
class socket_full_udp_t : NEOIP_COPY_CTOR_DENY, public socket_full_vapi_t
						, public socket_stream_vapi_t, public socket_mtu_vapi_t
						, private udp_full_cb_t, private nlay_full_cb_t
						{
private:
	...
	socket_event_t		reported_fatal_event;	//!< used by socket_full_close_udp_t
...
public:
	/*************** ctor/dtor	***************************************/
	socket_full_udp_t()							throw();
	~socket_full_udp_t()							throw();

	/*************** Setup function	***************************************/
	socket_err_t	set_ctor_param(udp_full_t *udp_full, nlay_full_t *nlay_full
...
#endif	/* __NEOIP_SOCKET_FULL_UDP_HPP__ */
