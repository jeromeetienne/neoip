...
#ifndef __NEOIP_SOCKET_PORTID_TCP_HPP__
#define __NEOIP_SOCKET_PORTID_TCP_HPP__
/* system include */
/* local include */
...
/** \brief socket_domain_t::TCP implementation of the socket_portid_vapi_t
 */
class socket_portid_tcp_t : public socket_portid_vapi_t {
private:
...
public:
	...
	FACTORY_PRODUCT_DECLARATION(socket_portid_vapi_t, socket_portid_tcp_t);
...
#endif	/* __NEOIP_SOCKET_PORTID_TCP_HPP__ */
