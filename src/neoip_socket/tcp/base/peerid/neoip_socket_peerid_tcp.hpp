...
#ifndef __NEOIP_SOCKET_PEERID_TCP_HPP__
#define __NEOIP_SOCKET_PEERID_TCP_HPP__
/* system include */
/* local include */
...
/** \brief socket_domain_t::TCP implementation of the socket_peerid_vapi_t
 */
class socket_peerid_tcp_t : public socket_peerid_vapi_t {
private:
...
public:
	...
	FACTORY_PRODUCT_DECLARATION(socket_peerid_vapi_t, socket_peerid_tcp_t);

	/************** List of friend class	*******************************/
	friend class	socket_helper_tcp_t;
};

NEOIP_NAMESPACE_END

#endif	/* __NEOIP_SOCKET_PEERID_TCP_HPP__ */
