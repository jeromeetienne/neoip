...
#ifndef __NEOIP_BT_SWARM_SCHED_REQUEST_WIKIDBG_HPP__ 
#define __NEOIP_BT_SWARM_SCHED_REQUEST_WIKIDBG_HPP__ 
/* system include */
/* local include */
...
#endif	/* __NEOIP_BT_SWARM_SCHED_REQUEST_WIKIDBG_HPP__  */
