...
#ifndef __NEOIP_SLAY_RESP_BTJAMSTD_HPP__
#define __NEOIP_SLAY_RESP_BTJAMSTD_HPP__
/* system include */
/* local include */
...
/** \brief class for the \ref slay_resp_t of the slay_domain_t::BTJAMSTD
 */
class slay_resp_btjamstd_t : public slay_resp_vapi_t {
private:
	slay_profile_t		m_slay_profile;	//!< the slay_profile_t for this responder
	bt_jamstd_resp_t	m_btjamstd_resp;
public:
	/*************** ctor/dtor	***************************************/
	slay_resp_btjamstd_t()			throw();
	~slay_resp_btjamstd_t()			throw();
	...
	pkt_t &			xmit_buffer()	throw()		{ return m_btjamstd_resp.xmit_buffer();	}
	...
	FACTORY_PRODUCT_DECLARATION_NOCLONE(slay_resp_vapi_t, slay_resp_btjamstd_t);
};

NEOIP_NAMESPACE_END

#endif	/* __NEOIP_SLAY_RESP_BTJAMSTD_HPP__ */
