...
#ifndef __NEOIP_UPNP_WATCH_WIKIDBG_HPP__ 
#define __NEOIP_UPNP_WATCH_WIKIDBG_HPP__ 
/* system include */
/* local include */
...
// declaration of the wikidbg_init_cb_t for upnp_watch_t
void upnp_watch_wikidbg_init(wikidbg_keyword_db_t &keyword_db)	throw();


NEOIP_NAMESPACE_END

#endif	/* __NEOIP_UPNP_WATCH_WIKIDBG_HPP__  */
