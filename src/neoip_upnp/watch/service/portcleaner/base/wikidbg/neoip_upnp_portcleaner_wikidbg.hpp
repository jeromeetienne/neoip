...
#ifndef __NEOIP_UPNP_PORTCLEANER_WIKIDBG_HPP__ 
#define __NEOIP_UPNP_PORTCLEANER_WIKIDBG_HPP__ 
/* system include */
/* local include */
...
// declaration of the wikidbg_init_cb_t for upnp_portcleaner_t
void upnp_portcleaner_wikidbg_init(wikidbg_keyword_db_t &keyword_db)	throw();


NEOIP_NAMESPACE_END

#endif	/* __NEOIP_UPNP_PORTCLEANER_WIKIDBG_HPP__  */
