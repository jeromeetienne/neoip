/*! \file
    \brief Declaration of the upnp_call_getport_t
    
*/


#ifndef __NEOIP_UPNP_CALL_GETPORT_HPP__ 
#define __NEOIP_UPNP_CALL_GETPORT_HPP__ 
/* system include */
/* local include */
...
/** \brief handle the upnp_call_getport_t
 */
class upnp_call_getport_t : NEOIP_COPY_CTOR_DENY, private upnp_call_cb_t {
private:
	...
	/*************** callback stuff	***************************************/
	upnp_call_getport_cb_t *callback;	//!< callback used to notify result
	void *		userptr;	//!< userptr associated with the callback
	bool		notify_callback(const upnp_err_t &upnp_err)	throw();
	TOKEEP_CHECK_DECL_DFL();	//!< used to sanity check the 'tokeep' value returned by callback
public:
	/*************** ctor/dtor	***************************************/
	upnp_call_getport_t()	throw();
	~upnp_call_getport_t()	throw();

	/*************** setup function	***************************************/
	upnp_call_getport_t &revendian(bool new_value) 	throw()	{ m_revendian = new_value; return *this;}
	upnp_call_getport_t &set_profile(const upnp_call_profile_t &profile)	throw();	
	upnp_err_t	start(const upnp_disc_res_t &disc_res, uint16_t port_pview
				, const upnp_sockfam_t &sock_fam
...
#endif // __NEOIP_UPNP_CALL_GETPORT_HPP__ 
