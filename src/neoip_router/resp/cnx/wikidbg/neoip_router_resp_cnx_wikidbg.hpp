...
#ifndef __NEOIP_ROUTER_RESP_CNX_WIKIDBG_HPP__ 
#define __NEOIP_ROUTER_RESP_CNX_WIKIDBG_HPP__ 
/* system include */
/* local include */
...
// declaration of the wikidbg_init_cb_t for router_resp_cnx_t
void router_resp_cnx_wikidbg_init(wikidbg_keyword_db_t &keyword_db)	throw();


NEOIP_NAMESPACE_END

#endif	/* __NEOIP_ROUTER_RESP_CNX_WIKIDBG_HPP__  */
