/*! \file
    \brief main() for neoip-casti

\par Brief Description
This application is used to import in neoip-cast an http streaming

*/

/* system include */
/* local include */
#include "neoip_casti_info.hpp"
...
int main_internal(int argc, char **argv)
{
	...
	libsess_err_t	libsess_err	= lib_apps->start(argc, argv, casti_apps_t::clineopt_arr()
	...
	// launch the casti_apps_t
	lib_session_exit_ptr_t<casti_apps_t> casti_apps(nipmem_new casti_apps_t(), lib_session_exit_t::EXIT_ORDER_APPS);
	bt_err_t	bt_err		= casti_apps->start();
	if( bt_err.failed() ){
