...
#ifndef __NEOIP_CASTI_INETREACH_HTTPD_WIKIDBG_HPP__ 
#define __NEOIP_CASTI_INETREACH_HTTPD_WIKIDBG_HPP__ 
/* system include */
/* local include */
...
// declaration of the wikidbg_init_cb_t for casti_inetreach_httpd_t
void casti_inetreach_httpd_wikidbg_init(wikidbg_keyword_db_t &keyword_db)	throw();


NEOIP_NAMESPACE_END

#endif	/* __NEOIP_CASTI_INETREACH_HTTPD_WIKIDBG_HPP__  */
