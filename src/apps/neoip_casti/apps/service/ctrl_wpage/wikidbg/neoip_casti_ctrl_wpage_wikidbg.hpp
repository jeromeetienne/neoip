...
#ifndef __NEOIP_CASTI_CTRL_WPAGE_WIKIDBG_HPP__ 
#define __NEOIP_CASTI_CTRL_WPAGE_WIKIDBG_HPP__ 
/* system include */
/* local include */
...
// declaration of the wikidbg_init_cb_t for casti_ctrl_wpage_t
void casti_ctrl_wpage_wikidbg_init(wikidbg_keyword_db_t &keyword_db)	throw();


NEOIP_NAMESPACE_END

#endif	/* __NEOIP_CASTI_CTRL_WPAGE_WIKIDBG_HPP__  */
