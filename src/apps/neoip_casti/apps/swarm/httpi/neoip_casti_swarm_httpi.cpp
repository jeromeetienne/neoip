/*! \file
    \brief Definition of the \ref casti_swarm_httpi_t
    
\par Brief Description
casti_swarm_httpi_t handle all the httpi stuff for the casti_swarm_t
...
/** \brief Constructor
 */
casti_swarm_httpi_t::casti_swarm_httpi_t()	throw()
{
	// log to debug
	KLOG_DBG("enter");
	// zero some field
 ...
 */
casti_swarm_httpi_t &	casti_swarm_httpi_t::profile(const casti_swarm_httpi_profile_t &m_profile)	throw()
{
 ...
 */
bt_err_t casti_swarm_httpi_t::start(casti_swarm_t *m_casti_swarm)		throw()
{
	// log to debug
	KLOG_WARN("enter");
	// copy the parameter
 ...
 */
bt_ezswarm_t *	casti_swarm_httpi_t::bt_ezswarm()	const throw()
{
 ...
 */
casti_swarm_udata_t *	casti_swarm_httpi_t::swarm_udata()	const throw()
{
 ...
 */
casti_swarm_spos_t*	casti_swarm_httpi_t::swarm_spos()	const throw()
{
 ...
 */
bool	casti_swarm_httpi_t::handle_chunk_avail(const file_size_t &chunk_len)		throw()
{
