...
#ifndef __NEOIP_BTRELAY_APPS_WIKIDBG_HPP__ 
#define __NEOIP_BTRELAY_APPS_WIKIDBG_HPP__ 
/* system include */
/* local include */
...
// declaration of the wikidbg_init_cb_t for btrelay_apps_t
void btrelay_apps_wikidbg_init(wikidbg_keyword_db_t &keyword_db)	throw();


NEOIP_NAMESPACE_END

#endif	/* __NEOIP_BTRELAY_APPS_WIKIDBG_HPP__  */
