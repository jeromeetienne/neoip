...
#   - server = XMLRPC::Client.new2("http://localhost/~jerome/oload/cast_mdata_echo_server/cast_mdata_echo_server.rb")
#   - server.call("set_cast_mdata_push", "superstream.flv", { :slota => 'bip', :goup => 'slsdfadfsl' })
