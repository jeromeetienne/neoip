...
#ifndef __NEOIP_OLOAD_FLASH_XDOM_WIKIDBG_HPP__ 
#define __NEOIP_OLOAD_FLASH_XDOM_WIKIDBG_HPP__ 
/* system include */
/* local include */
...
// declaration of the wikidbg_init_cb_t for oload_flash_xdom_t
void oload_flash_xdom_wikidbg_init(wikidbg_keyword_db_t &keyword_db)	throw();


NEOIP_NAMESPACE_END

#endif	/* __NEOIP_OLOAD_FLASH_XDOM_WIKIDBG_HPP__  */
