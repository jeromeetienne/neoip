...
int main(int argc, char **argv)
{
	...
	libsess_err_t	libsess_err	= lib_apps->start(argc, argv, get_apps_t::clineopt_arr()
	...
	// launch the get_apps_t
	lib_session_exit_ptr_t<get_apps_t>	get_apps(nipmem_new get_apps_t(), lib_session_exit_t::EXIT_ORDER_APPS);
	bt_err_t	bt_err		= get_apps->start();
	if( bt_err.failed() ){
