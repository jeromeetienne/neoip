...
#ifndef __NEOIP_GET_INFO_HPP__
#define __NEOIP_GET_INFO_HPP__
...
#define NEOIP_APPS_CANON_NAME	"neoip_get"
#define NEOIP_APPS_HUMAN_NAME	"NeoIP get"
#include			"neoip_get_info_version.hpp"
#define NEOIP_APPS_SUMMARY	"command line tool to download from neoip file technology"
