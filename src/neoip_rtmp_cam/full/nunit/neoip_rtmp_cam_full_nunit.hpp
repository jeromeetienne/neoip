...
#ifndef __NEOIP_RTMP_CAM_FULL_NUNIT_HPP__
#define __NEOIP_RTMP_CAM_FULL_NUNIT_HPP__
/* system include */
/* local include */
 ...
 */
class rtmp_cam_full_testclass_t : public nunit_testclass_api_t, private rtmp_cam_resp_cb_t
				, private rtmp_cam_full_cb_t {
private:
	nunit_testclass_ftor_t	nunit_ftor;	//!< the functor to notify nunit_res_t asynchronously
	rtmp_cam_listener_t *	cam_listener;
...
public:
	/*************** ctor/dtor	***************************************/
	rtmp_cam_full_testclass_t()	throw();
	~rtmp_cam_full_testclass_t()	throw();
...
#endif	/* __NEOIP_RTMP_CAM_FULL_NUNIT_HPP__  */
