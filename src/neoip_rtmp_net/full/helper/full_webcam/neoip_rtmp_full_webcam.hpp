/*! \file
    \brief Header of the rtmp_full_webcam_t

*/


#ifndef __NEOIP_RTMP_FULL_WEBCAM_HPP__
#define __NEOIP_RTMP_FULL_WEBCAM_HPP__
/* system include */
/* local include */
...
/** \brief class definition for rtmp_full_webcam_t
 */
class rtmp_full_webcam_t : NEOIP_COPY_CTOR_DENY, private rtmp_full_cb_t, public object_slotid_t {
private:
	/************** rtmp_full__t	****************************************/
	...
	/*************** callback stuff	***************************************/
	rtmp_full_webcam_cb_t *	callback;	//!< callback used to notify result
	void *			userptr;	//!< userptr associated with the callback
	bool			notify_callback(const rtmp_event_t &event)	throw();
	TOKEEP_CHECK_DECL_DFL();	//!< used to sanity check the 'tokeep' value returned by callback
public:
	/*************** ctor/dtor	***************************************/
	rtmp_full_webcam_t()		throw();
	~rtmp_full_webcam_t()		throw();

	/*************** setup function	***************************************/
	rtmp_err_t	start(rtmp_full_t *rtmp_full, rtmp_full_webcam_cb_t *callback
						, void *userptr)		throw();
...
#endif	/* __NEOIP_RTMP_FULL_WEBCAM_HPP__  */
