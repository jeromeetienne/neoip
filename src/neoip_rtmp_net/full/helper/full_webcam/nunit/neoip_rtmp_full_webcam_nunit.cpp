...
#include "neoip_rtmp_full_webcam.hpp"
...
/** \brief Constructor
 */
rtmp_full_webcam_testclass_t::rtmp_full_webcam_testclass_t()	throw()
{
	// zero some field
	rtmp_resp	= NULL;
	full_webcam	= NULL;
 ...
 */
nunit_err_t	rtmp_full_webcam_testclass_t::neoip_nunit_testclass_init()	throw()
{
	rtmp_err_t	rtmp_err;
	// build the resp_arg
 ...
 */
void	rtmp_full_webcam_testclass_t::neoip_nunit_testclass_deinit()	throw()
{
	// log to debug
	KLOG_DBG("enter");
	// delete variables if needed
	nipmem_zdelete	full_webcam;
...
/** \brief Test function
 */
nunit_res_t	rtmp_full_webcam_testclass_t::general(const nunit_testclass_ftor_t &testclass_ftor) throw()
{
 ...
 */
bool	rtmp_full_webcam_testclass_t::neoip_rtmp_resp_cb(void *cb_userptr, rtmp_resp_t &cb_rtmp_resp
						, rtmp_full_t *cb_rtmp_full)	throw()
{
	...
	// start the rtmp_full_webcam_t
	rtmp_err_t	rtmp_err;
	full_webcam	= nipmem_new rtmp_full_webcam_t();
	rtmp_err	= full_webcam->start(cb_rtmp_full, this, NULL);
	if( rtmp_err.failed() ){
		KLOG_ERR("Cant start the rtmp_full_webcam_t due to " << rtmp_err);
		nipmem_zdelete full_webcam;
		return true;
	}
...
/** \brief callback notified by \ref rtmp_resp_t when to notify an event
 */
bool	rtmp_full_webcam_testclass_t::neoip_rtmp_full_webcam_cb(void *cb_userptr
			, rtmp_full_webcam_t &cb_full_webcam, const rtmp_event_t &rtmp_event)	throw()
{
	// log to debug
	...
	if( rtmp_event.is_fatal() ){
		...
		// delete rtmp_full_webcam_t
		nipmem_zdelete	full_webcam;
		// return dontkeep as rtmp_full_webcam_t just got deleted
		return false;
	}
