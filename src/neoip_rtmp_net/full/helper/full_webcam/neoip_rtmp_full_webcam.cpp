...
/** \brief Constructor
 */
rtmp_full_webcam_t::rtmp_full_webcam_t()	throw()
{
	// zero some fields
	rtmp_full	= NULL;
}
 ...
 */
rtmp_err_t	rtmp_full_webcam_t::start(rtmp_full_t *p_rtmp_full
		, rtmp_full_webcam_cb_t *callback, void *userptr)	throw()
{
	// log to debug
	KLOG_DBG("enter");
	// copy the parameter
...
/** \brief Send data thru the rtmp_full_webcam_t
 */
rtmp_err_t	rtmp_full_webcam_t::send(const void *data_ptr, size_t data_len) 	throw()
{
 ...
 */
bool	rtmp_full_webcam_t::neoip_rtmp_full_cb(void *userptr, rtmp_full_t &cb_rtmp_full
 ...
 */
bool	rtmp_full_webcam_t::handle_invoke(const rtmp_event_t &rtmp_event)	throw()
{
	// get the packet from the event
	datum_t		pktbody;
 ...
 */
bool	rtmp_full_webcam_t::handle_invoke_connect(const rtmp_pkthd_t &rtmp_pkthd
 ...
 */
bool	rtmp_full_webcam_t::handle_invoke_createStream(const rtmp_pkthd_t &rtmp_pkthd
						, bytearray_t &amf0_body)	throw()
{
	// sanity check - at this point, rtmp_pkthd_t MUST BE rtmp_type_t::INVOKE
	DBG_ASSERT( rtmp_pkthd.type() == rtmp_type_t::INVOKE );
 ...
 */
bool rtmp_full_webcam_t::notify_callback(const rtmp_event_t &event)	throw()
{
	...
	// notify the caller
	bool tokeep = callback->neoip_rtmp_full_webcam_cb(userptr, *this, event);
