...
#ifndef __NEOIP_BT_EZSWARM_WIKIDBG_HPP__ 
#define __NEOIP_BT_EZSWARM_WIKIDBG_HPP__ 
/* system include */
/* local include */
...
// declaration of the wikidbg_init_cb_t for bt_ezswarm_t
void bt_ezswarm_wikidbg_init(wikidbg_keyword_db_t &keyword_db)	throw();


NEOIP_NAMESPACE_END

#endif	/* __NEOIP_BT_EZSWARM_WIKIDBG_HPP__  */
