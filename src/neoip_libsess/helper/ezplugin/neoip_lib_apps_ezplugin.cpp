/*! \file
    \brief Definition of the \ref lib_apps_ezplugin_t class
 ...
 *   lib_session_t 
 */
void	lib_apps_ezplugin_t::insert_all_available()	throw()
{
	// insert all the socket_*_t factory_product_t
	socket_helper_udp_t	::factory_domain_insert();
	socket_helper_ntudp_t	::factory_domain_insert();
	socket_helper_ntlay_t	::factory_domain_insert();
	...
	slay_helper_btjamstd_t	::factory_domain_insert();
	slay_helper_tls_t	::factory_domain_insert();
}
