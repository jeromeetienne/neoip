...
#include "neoip_bt_scasti_mod_cb.hpp"
...
private:
	...
	void			push_flv_header()				throw();
	void			push_flv_avideo(const rtmp_event_t &rtmp_event)	throw();

	/*************** bt_scasti_mod_vapi_t	*******************************/
	bt_scasti_mod_vapi_t *	m_mod_vapi;	//!< pointer on the bt_scasti_mod_vapi_t
	bool			neoip_bt_scasti_mod_cb(void *cb_userptr, bt_scasti_mod_vapi_t &cb_mod_vapi
	...
	void			launch_write_if_needed()			throw();
