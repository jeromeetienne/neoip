/*! \file
    \brief Definition of the \ref bt_scasti_rtmp_profile_t
...
/** \brief Constructor
 */
bt_scasti_rtmp_profile_t::bt_scasti_rtmp_profile_t()	throw()
{
 ...
 */
bt_err_t	bt_scasti_rtmp_profile_t::check()	const throw()
{
	// return no error
	return bt_err_t::OK;
}
