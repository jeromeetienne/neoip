/*! \file
    \brief Header of the \ref bt_httpi_profile_t

*/


#ifndef __NEOIP_BT_HTTPI_PROFILE_HPP__ 
#define __NEOIP_BT_HTTPI_PROFILE_HPP__ 
/* system include */
/* local include */
...
#	define PROFILE_VAR_PLAIN(var_type, var_name)									\
	...
	public:	const var_type &	var_name()	const throw()	{ return var_name ## _val; }	\
		bt_httpi_profile_t &	var_name(const var_type &value)	throw()			\
...
#endif	/* __NEOIP_BT_HTTPI_PROFILE_HPP__  */
