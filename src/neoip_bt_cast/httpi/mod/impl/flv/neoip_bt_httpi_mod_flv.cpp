/*! \file
    \brief Class to handle the bt_httpi_mod_flv_t
    
\par Brief Description
bt_httpi_mod_flv_t is a bt_httpi_mod_vapi_t which parse FLV flash movie files.
- It provides a prefix_header valid for FLV file with bt_httpi_mod_vapi_t::prefix_header() 
- It extract the keyframe positions to export them with bt_httpi_mod_vapi_t::cast_spos_pop()
...
/** \brief Constructor
 */
bt_httpi_mod_flv_t::bt_httpi_mod_flv_t()	throw()
{
	// zero some variable
	flv_parse	= NULL;
	m_type		= bt_httpi_mod_type_t::FLV;
}
 ...
 */
bt_err_t	bt_httpi_mod_flv_t::start(bt_httpi_t *p_bt_httpi)	throw()
{
	// copy the parameters
...
/** \brief notify new data to the this bt_httpi_mod_vapi_t
 */
void	bt_httpi_mod_flv_t::notify_data(const datum_t &data)	throw()
{
 ...
 */
bt_cast_spos_t	bt_httpi_mod_flv_t::cast_spos_pop()		throw()	
{
 ...
 */
datum_t		bt_httpi_mod_flv_t::prefix_header()	const throw()
{
 ...
 */
bool	bt_httpi_mod_flv_t::neoip_flv_parse_cb(void *cb_userptr, flv_parse_t &cb_flv_parse
					, const flv_parse_event_t &parse_event)	throw()
{
	...
	if( parse_event.is_fatal() ){
		...
		bt_httpi_event_t event	= bt_httpi_event_t::build_error(bt_err);
		return m_bt_httpi->mod_vapi_notify_callback(event);
	}
 ...
 */
bool	bt_httpi_mod_flv_t::parse_for_cast_spos(const flv_parse_event_t &parse_event)throw()
{
	...
	// notify the caller - that the bt_httpi_event_t::MOD_UPDATED
	bt_httpi_event_t httpi_event	= bt_httpi_event_t::build_mod_updated();
	bool	tokeep	= m_bt_httpi->mod_vapi_notify_callback(httpi_event);
	if( !tokeep )	return false;
 ...
 */
bool	bt_httpi_mod_flv_t::parse_for_prefix_header(const flv_parse_event_t &parse_event)throw()
{
