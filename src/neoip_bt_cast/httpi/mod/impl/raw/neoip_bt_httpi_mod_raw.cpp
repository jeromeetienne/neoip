/*! \file
    \brief Class to handle the bt_httpi_mod_raw_t

\par Brief Description
bt_httpi_mod_raw_t is a bt_httpi_mod_vapi_t which doesnt modify the stream or provide
any kind of data. this is just a place holder for bt_httpi_mod_vapi_t.
...
/** \brief Constructor
 */
bt_httpi_mod_raw_t::bt_httpi_mod_raw_t()	throw()
{
	// zero some variable
	m_type	= bt_httpi_mod_type_t::RAW;
}
 ...
 */
bt_httpi_mod_raw_t &	bt_httpi_mod_raw_t::profile(const bt_httpi_mod_raw_profile_t &p_profile)	throw()
{
 ...
 */
bt_err_t	bt_httpi_mod_raw_t::start(bt_httpi_t *p_bt_httpi)	throw()
{
	// copy the parameters
 ...
 */
void	bt_httpi_mod_raw_t::notify_data(const datum_t &data)	throw()
{
	// log to debug
	KLOG_DBG("enter");
 ...
 */
bt_cast_spos_t	bt_httpi_mod_raw_t::cast_spos_pop()		throw()	
{
 ...
 */
void	bt_httpi_mod_raw_t::cast_spos_queue(const file_size_t &byte_offset)	throw()
{
 ...
 */
bool	bt_httpi_mod_raw_t::neoip_zerotimer_expire_cb(zerotimer_t &cb_zerotimer, void *userptr) throw()
{
 ...
 */
bool	bt_httpi_mod_raw_t::neoip_timeout_expire_cb(void *userptr, timeout_t &cb_timeout) throw()
{
	// log to debug
	KLOG_ERR("enter");
