...
/********************* bt_scasti_httpt	***************************************/
	// init the testclass for the bt_scasti_httpt
	nunit_testclass_t<bt_scasti_httptestclass_t> *	bt_scasti_httptestclass;
	bt_scasti_httptestclass	= nipmem_new nunit_testclass_t<bt_scasti_httptestclass_t>("scasti_http"
							, nipmem_new bt_scasti_httptestclass_t());
	// add some test functions
	bt_scasti_httptestclass->append("general"	, &bt_scasti_httptestclass_t::general);
	// add the testclass to the nunit_suite
	bt_cast_suite->append(bt_scasti_httptestclass);
#endif
