...
#ifndef __NEOIP_BT_CAST_MDATA_DOPUBLISH_WIKIDBG_HPP__ 
#define __NEOIP_BT_CAST_MDATA_DOPUBLISH_WIKIDBG_HPP__ 
/* system include */
/* local include */
...
#endif	/* __NEOIP_BT_CAST_MDATA_DOPUBLISH_WIKIDBG_HPP__  */
