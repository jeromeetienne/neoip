...
#ifndef __NEOIP_NTUDP_NPOS_SADDRECHO_WIKIDBG_HPP__ 
#define __NEOIP_NTUDP_NPOS_SADDRECHO_WIKIDBG_HPP__ 
/* system include */
/* local include */
...
// declaration of the wikidbg_init_cb_t for ntudp_npos_saddrecho_t
void ntudp_npos_saddrecho_wikidbg_init(wikidbg_keyword_db_t &keyword_db)	throw();


NEOIP_NAMESPACE_END

#endif	/* __NEOIP_NTUDP_NPOS_SADDRECHO_WIKIDBG_HPP__  */
