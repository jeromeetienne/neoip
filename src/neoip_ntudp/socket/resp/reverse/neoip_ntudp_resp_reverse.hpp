/*! \file
    \brief Declaration of the ntudp_resp_reverse_t
    
*/


#ifndef __NEOIP_NTUDP_RESP_REVERSE_HPP__ 
#define __NEOIP_NTUDP_RESP_REVERSE_HPP__ 
/* system include */
/* local include */
 ...
 */
class ntudp_resp_reverse_t : NEOIP_COPY_CTOR_DENY, private udp_client_cb_t, private timeout_cb_t {
private:
	...
	/*************** packet building	*******************************/
	pkt_t 		build_reverse_cnx_reply()	const throw();
	pkt_t 		build_reverse_cnx_r2i_ack()	const throw();
	...
	bool		recv_reverse_cnx_i2r_ack(pkt_t &pkt)			throw(serial_except_t);
	bool		recv_error_pkt(pkt_t &pkt)				throw(serial_except_t);

	/*************** Callback	***************************************/
	ntudp_resp_reverse_cb_t*callback;	//!< the callback to notify result
...
public:
	/*************** ctor/dtor	***************************************/
	ntudp_resp_reverse_t(ntudp_resp_t *ntudp_resp, ntudp_resp_reverse_cb_t *callback
							, void * userptr)	throw();
	~ntudp_resp_reverse_t()							throw();
...
#endif	/* __NEOIP_NTUDP_RESP_REVERSE_HPP__  */
