...
#ifndef __NEOIP_NTUDP_ITOR_ESTARELAY_2PEER_CB_HPP__ 
#define __NEOIP_NTUDP_ITOR_ESTARELAY_2PEER_CB_HPP__ 
/* system include */
/* local include */
...
// forward declaration
class ntudp_itor_estarelay_2peer_t;
class udp_full_t;
class pkt_t;


/** \brief the callback class for ntudp_itor_estarelay_2peer_t
 */
class ntudp_itor_estarelay_2peer_cb_t {
public:
	 ...
	 */
	virtual bool neoip_ntudp_itor_estarelay_2peer_cb(void *cb_userptr
				, ntudp_itor_estarelay_2peer_t &cb_ntudp_itor_estarelay_2peer
				, udp_full_t *udp_full
				, const pkt_t &estapkt_in, const pkt_t &estapkt_out)	throw() = 0;
	virtual ~ntudp_itor_estarelay_2peer_cb_t() {};
};

NEOIP_NAMESPACE_END

#endif	/* __NEOIP_NTUDP_ITOR_ESTARELAY_2PEER_CB_HPP__  */
