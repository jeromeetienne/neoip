...
#ifndef __NEOIP_NTUDP_SOCKET_DIRECT_NUNIT_HPP__ 
#define __NEOIP_NTUDP_SOCKET_DIRECT_NUNIT_HPP__ 
/* system include */
#include <set>
/* local include */
 ...
 */
class ntudp_socket_direct_testclass_t : public nunit_testclass_api_t
...
public:
	/*************** ctor/dtor	***************************************/
	ntudp_socket_direct_testclass_t()	throw();
	~ntudp_socket_direct_testclass_t()	throw();
...
#endif	/* __NEOIP_NTUDP_SOCKET_DIRECT_NUNIT_HPP__  */
