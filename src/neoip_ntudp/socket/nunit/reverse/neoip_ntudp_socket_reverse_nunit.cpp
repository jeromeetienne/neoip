...
/** \brief Constructor
 */
ntudp_socket_reverse_testclass_t::ntudp_socket_reverse_testclass_t()	throw()
{
	// zero some field
	peer_4client	= NULL;
	peer_4relay	= NULL;
 ...
 */
nunit_err_t	ntudp_socket_reverse_testclass_t::neoip_nunit_testclass_init()	throw()
{
	...
	ntudp_err	= ntudp_nunit_peer_start_default(peer_4server);
	if( ntudp_err.failed() )	return nunit_err_t(nunit_err_t::ERROR, ntudp_err.to_string());
 ...
 */
void	ntudp_socket_reverse_testclass_t::neoip_nunit_testclass_deinit()	throw()
{
	// log to debug
	KLOG_DBG("enter");
 ...
 */
nunit_res_t	ntudp_socket_reverse_testclass_t::one_client(const nunit_testclass_ftor_t &testclass_ftor) throw()
{
	// launch 1 client
	ntudp_err_t	ntudp_err;
 ...
 */
nunit_res_t	ntudp_socket_reverse_testclass_t::ten_client(const nunit_testclass_ftor_t &testclass_ftor) throw()
{
	// launch 1 client
	ntudp_err_t	ntudp_err;
 ...
 */
ntudp_err_t	ntudp_socket_reverse_testclass_t::launch_nb_client_close(size_t nb_launch)	throw()
{
	ntudp_err_t	ntudp_err;
 ...
 */
void	ntudp_socket_reverse_testclass_t::delete_all_client_close()	throw()
{
	// delete all the pending client_close
 ...
 */
bool ntudp_socket_reverse_testclass_t::ntudp_rdvpt_ftor_cb(void *userptr, const ntudp_rdvpt_t &ntudp_rdvpt)	throw()
{
	// log to debug
 ...
 */
bool ntudp_socket_reverse_testclass_t::neoip_ntudp_socket_nunit_client_close_cb(void *cb_userptr
