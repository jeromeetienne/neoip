/*! \file
    \brief Definition of the \ref kad_rpcquery_some_t class
...
/** \brief Constructor
 */
kad_rpcquery_some_t::kad_rpcquery_some_t()		throw()
{
	// zero some field
	m_rpcpeer	= NULL;
	m_kad_query_some= NULL;
	httpd_request	= NULL;
}
...
kad_rpcquery_some_t::~kad_rpcquery_some_t()		throw()
{
	...
	if( m_rpcpeer )	rpcpeer()->rpcquery_some_unlink(this);
	// delete the kad_query_some_t if needed
	nipmem_zdelete	m_kad_query_some;
}
 ...
 */
kad_err_t	kad_rpcquery_some_t::start(kad_rpcresp_t *kad_rpcresp, const httpd_request_t &recved_request
							...
							, xmlrpc_parse_t &xmlrpc_parse)	throw()
{
	...
	rpcpeer()->rpcquery_some_dolink(this);
	...
	// start the kad_query_some_t
	m_kad_query_some= nipmem_new kad_query_some_t();
	kad_err		= kad_query_some()->start(rpcpeer()->kad_peer(), keyid, max_nb_record, max_nb_node
...
////////////////////////////////////////////////////////////////////////////////
////////////////////////////////////////////////////////////////////////////////
//			kad_query_some_t callback
////////////////////////////////////////////////////////////////////////////////
////////////////////////////////////////////////////////////////////////////////

/** \brief callback notified when a kad_query_some_t has an event to notify
 */
bool kad_rpcquery_some_t::neoip_kad_query_some_cb(void *cb_userptr, kad_query_some_t &cb_kad_query_some
