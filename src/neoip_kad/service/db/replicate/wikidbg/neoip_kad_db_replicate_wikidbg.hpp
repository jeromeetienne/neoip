...
#ifndef __NEOIP_KAD_DB_REPLICATE_WIKIDBG_HPP__ 
#define __NEOIP_KAD_DB_REPLICATE_WIKIDBG_HPP__ 
/* system include */
/* local include */
...
// declaration of the wikidbg_init_cb_t for kad_db_t
void kad_db_replicate_wikidbg_init(wikidbg_keyword_db_t &keyword_db)	throw();


NEOIP_NAMESPACE_END

#endif	/* __NEOIP_KAD_DB_REPLICATE_WIKIDBG_HPP__  */
