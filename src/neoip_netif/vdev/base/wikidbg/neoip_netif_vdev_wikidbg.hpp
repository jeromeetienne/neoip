...
#ifndef __NEOIP_NETIF_VDEV_WIKIDBG_HPP__ 
#define __NEOIP_NETIF_VDEV_WIKIDBG_HPP__ 
/* system include */
/* local include */
...
// declaration of the wikidbg_init_cb_t for netif_vdev_t
void netif_vdev_wikidbg_init(wikidbg_keyword_db_t &keyword_db)	throw();


NEOIP_NAMESPACE_END

#endif	/* __NEOIP_NETIF_VDEV_WIKIDBG_HPP__  */
