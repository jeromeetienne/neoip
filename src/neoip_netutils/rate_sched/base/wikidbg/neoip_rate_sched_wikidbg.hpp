...
#ifndef __NEOIP_RATE_SCHED_WIKIDBG_HPP__ 
#define __NEOIP_RATE_SCHED_WIKIDBG_HPP__ 
/* system include */
/* local include */
...
// declaration of the wikidbg_init_cb_t for rate_sched_t
void rate_sched_wikidbg_init(wikidbg_keyword_db_t &keyword_db)	throw();


NEOIP_NAMESPACE_END

#endif	/* __NEOIP_RATE_SCHED_WIKIDBG_HPP__  */
